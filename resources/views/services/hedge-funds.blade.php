...
@section('title', 'Hedge Fund | ' . config('app.full_company_name'))
      ...
      <div class="row">
        ...
        <div class="col-md-5">
          <div class="breadcrumbs">
            <a href="{{url('/')}}">Home</a><i class="icon icon-arrows-right"></i><a href="{{url('our-services')}}">OUR SERVICES</a><span class="slash-divider">/</span><span class="bread-current">Hedge Fund Services</span>
          </div>
        </div>
          ...
          <div class="col-sm-8 blog-main-posts">
            ...
            <div class="blog-post wow fadeIn pb-50">
              <div class="post-prev-img">
                <a href="#"><img src="{{asset('assets/images/fund.jpg')}}" alt="img"></a>
              </div>
