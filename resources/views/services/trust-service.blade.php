          ...
          <div class="col-sm-8 blog-main-posts">
            ...
            <div class="blog-post wow fadeIn pb-50">
              ...
              <div class="post-prev-text no-border">
                <p > {{ config('app.full_company_name') }} prioritises trust, transparency, and client satisfaction when providing trust services. Our experienced personnel are committed to providing great service and tailored solutions to each client's specific demands. Trust us to help you achieve financial success.
            ...
            <div class="row related-posts">
              ...
              <div class="col-sm-6 col-md-4 col-lg-4 wow fadeIn pb-50" data-wow-delay="200ms" >
                ...
                <div class="post-prev-img">
                  <a href="{{url('service/tax-efficient-investment')}}"><img src="{{asset('assets/images/tax.jpg')}}" alt="img"></a>
                </div>
