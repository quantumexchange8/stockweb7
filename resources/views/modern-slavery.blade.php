...
<div class="page-section pt-110-b-30-cont">
    <div class="container">
      ...
      <p class="bold mb-50">Through adherence to this disclaimer, ABC hopes to communicate our steadfast commitment to moral behaviour and our duty to help end modern slavery.</p>
      <div class="row">
            ...
            <div class="col-md-4 blog2-post-title-cont">
              ...
              <div class="post-prev-title">
                ...
                <div class="post-prev-info">
                  <a href="#">on Modern Slavery for ABC Ltd</a>
                </div>
              </div>
            </div>
        ...
        <div class="col-md-12 wow fadeIn pb-30" >
          <div class="row">
            ...
            <div class="col-md-8">
              <div class="blog2-post-prev-text text-justify">                     
                ABC is committed to operating in a way that aligns with our core beliefs and values. We vehemently condemn modern slavery in all of its manifestations, including child labour, forced labour, and human trafficking.
              </div>
            </div>
        ...
        <div class="col-md-12 wow fadeIn pb-30" >
            <div class="row">
              ...
              <div class="col-md-8">
                <div class="blog2-post-prev-text text-justify">                     
                    Strong standards and processes have been put in place by ABC to stop any participation with modern slavery. These consist of policies for ethical sourcing, training programmes for staff members, and channels for reporting any issues pertaining to modern slavery.
        ...
        <div class="col-md-12 wow fadeIn pb-30" >
            <div class="row">
              ...
              <div class="col-md-8">
                <div class="blog2-post-prev-text text-justify">                     
                    ABC actively backs coalition projects and advocacy campaigns to fight contemporary slavery. In order to promote progress in this important field, we aim to interact with industry colleagues, relevant organisations, and stakeholders.
                </div>
              </div>
