            ...
            <div class="col-md-11 col-md-offset-0">
                ...
                <div id="myTabContent" class="tab-content col-md-offset-1">
                    <div class="tab-pane fade text-color-darkgrey" id="environment">
                      <p>Taking on the role of stewards for future generations, {{config('app.short_company_name')}} will:</p>
                      <p>
                        <ul class="icon-list">
                    ...
                    <div class="tab-pane fade text-color-darkgrey" id="social">
                        <ul class="icon-list">
                            <li><i class="fa fa-angle-double-right"></i>Maintain a culture of integrity that holds {{config('app.short_company_name')}} and its employees accountable to the highest ethical standards, and continue to bring this culture into existence.
                            </li>
                    ...
                    <div class="tab-pane fade text-color-darkgrey" id="governance">
                        <ul class="icon-list">
                            <li><i class="fa fa-angle-double-right"></i>Establish a committee that is accountable to the Board in order to establish and keep {{config('app.short_company_name')}} accountable for its lofty environmental, social, and governance obligations
                            </li>
                            <li><i class="fa fa-angle-double-right"></i>Maintain an industry-leading compliance programme that not only contributes to the future development of {{config('app.short_company_name')}}'s ethical culture but also gives employees the ability to discuss and report ethical concerns.
                            </li>
                    ...
                    <div class="tab-pane fade in active text-color-darkgrey" id="overview">
                        <p>With a holistic approach to development, infrastructure, and environmental demands, {{config('app.short_company_name')}}'s work helps increase mobility, enhance communities, build resilience, and contribute to economic vitality. </p>
                        <p> These are all things that are accomplished through the organization's work. Throughout all of our markets, services, and activities, we incorporate sustainability and operate as stewards of the firm, ensuring that {{config('app.short_company_name')}} is always in a better position for the generations that will come after us.</p>
                        <p>{{config('app.short_company_name')}} is profoundly rooted in the Environmental, Social, and Governance (ESG) framework, which is thoroughly embedded in the fabric of the company thanks to its Generational Company philosophy and our historic Core Values.</p>
                    </div>
                  </div>
            </div>
        </div>
