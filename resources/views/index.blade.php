					...
					<div class="rs-fullscr-container">
						...
						<div id="rs-fullscr" class="tp-banner" >
							<ul>	
								...
								<!-- SLIDE 2 -->
								<li data-transition="zoomout" data-slotamount="1" data-masterspeed="1500" data-thumb="{{ asset('assets/images/revo-slider/rs-fullscr-thumb2.jpg') }}"  data-saveperformance="on"  data-title="IMAGINATION">
									
                  <!-- MAIN IMAGE -->
                  <img src="{{ asset('assets/images/revo-slider/dummy.png') }}"  alt="slidebg2" data-lazyload="{{ asset('assets/images/revo-slider/slide_1_2.jpg') }}" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
								...
								<!-- SLIDE 3 -->
								<li data-transition="zoomout" data-slotamount="1" data-masterspeed="1500" data-thumb="{{ asset('assets/images/revo-slider/rs-fullscr-thumb3.jpg') }}"  data-saveperformance="on"  data-title="WELCOM">
									
                  <!-- MAIN IMAGE -->
									<img src="{{ asset('assets/images/revo-slider/dummy.png') }}"  alt="citybg" data-lazyload="{{ asset('assets/images/revo-slider/slide_1_3.jpg') }}" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
									...
									<div class="rs-parallaxlevel-4  opacity-scroll2">					
										...
										<div class="tp-caption center-0-478 sfb"
											...
											data-elementdelay="0.1"
											data-endelementdelay="0.1"
											style="z-index: 9; max-width: auto; max-height: auto; white-space: nowrap;"><a class="button medium gray tp-button" href="https://1.envato.market/GVZ26">BUY NOW</a><a class="button medium thin hover-dark tp-button hide-479-736 ml-20" href="https://1.envato.market/1rOKNa">READ MORE</a>
										</div>					
									</div>					
